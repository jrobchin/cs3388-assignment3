...
class parametricTorus(parametricObject):
    ...
    def __init__(self,T=matrix(np.identity(4)),innerRadius=1.0,outerRadius=2.0,color=(0,0,0),reflectance=(0.0,0.0,0.0,0.0),uRange=(0.0,0.0),vRange=(0.0,0.0),uvDelta=(0.0,0.0)):
